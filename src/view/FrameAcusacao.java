...
class FrameAcusacao extends JFrame implements ObservadorIF,  ItemListener, ActionListener{
	protected PainelAcusacao panel = new PainelAcusacao();
	...
	public FrameAcusacao () {
		super("Acusacao " + control.getPlayerAtualNome());
