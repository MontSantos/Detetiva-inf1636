...
class FrameCheckList extends JFrame implements ObservadorIF{
	...
	public FrameCheckList (String S, int tipo) {
		super(S);
		...
		panel.add(scarlet);
		scarlet.setBounds(46, 65, botaoX, botaoY);
		...
		panel.add(mustard);
		mustard.setBounds(46, 65 + botaoY, botaoX, botaoY);
		...
		panel.add(white);
		white.setBounds(46, 65 + 2*botaoY, botaoX, botaoY);
		...
		panel.add(green);
		green.setBounds(46, 65 + 3*botaoY, botaoX, botaoY);               
		...
		panel.add(peacock);
		peacock.setBounds(46, 65 + 4*botaoY, botaoX, botaoY);     
		...
		panel.add(plum);
		plum.setBounds(46, 65 + 5*botaoY, botaoX, botaoY);     
		...
		panel.add(jantar);
		jantar.setBounds(46+ botaoX + 6, 65, botaoX, botaoY); 
		...
		panel.add(entrada);
		entrada.setBounds(46+ botaoX + 6, 65 + botaoY, botaoX, botaoY); 
		...
		panel.add(jogos);
		jogos.setBounds(46+ botaoX + 6, 65 + 2*botaoY, botaoX, botaoY); 
		...
		panel.add(cozinha);
		cozinha.setBounds(46+ botaoX + 6, 65 + 3*botaoY, botaoX, botaoY); 
		...
		biblioteca.setBounds(46+ botaoX + 6, 65 + 4*botaoY, botaoX, botaoY); 
		...
		panel.add(estar);
		estar.setBounds(46+ botaoX + 6, 65 + 5*botaoY, botaoX, botaoY); 
		...
		panel.add(musica);
		musica.setBounds(46+ botaoX + 6, 65 + 6*botaoY, botaoX, botaoY); 
		...
		escritorio.setBounds(46+ botaoX + 6, 65 + 7*botaoY, botaoX, botaoY); 
		...
		panel.add(jardim);
		jardim.setBounds(46+ botaoX + 6, 65 + 8*botaoY, botaoX, (int)( botaoY - ((float) (6*(h/600))))); 
		...
		panel.add(castical);
		castical.setBounds(46 + 2*botaoX + 12, 65, botaoX, botaoY);   
		...
		panel.add(revolver);
		revolver.setBounds(46 + 2*botaoX + 12, 65 + botaoY, botaoX, botaoY);   
		...
		panel.add(faca);
		faca.setBounds(46 + 2*botaoX + 12, 65 + 2*botaoY, botaoX, botaoY);   
		...
		panel.add(cano);
		cano.setBounds(46 + 2*botaoX + 12, 65 + 3*botaoY, botaoX, botaoY);   
		...
		panel.add(corda);
		corda.setBounds(46 + 2*botaoX +12, 65 + 4*botaoY, botaoX, botaoY);   
		...
		panel.add(chave);
		chave.setBounds(46 + 2*botaoX + 12, 65 + 5*botaoY, botaoX, botaoY);   
		...
		if (tipo == 1) {
			...
			panel.add(cancelar);
			cancelar.setBounds(46, 65 + 6 * botaoY,  botaoX, ((h - 140) - 6*botaoY));
			...
			panel.add(ok);
			ok.setBounds(46 + 2*(botaoX) + 12, 65 + 6 * botaoY,  botaoX, ((h - 140) - 6*botaoY));
